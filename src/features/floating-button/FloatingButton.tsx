const waNumber = '573158932278';
const waMessage = 'Hola, vengo de la web de NeoApp. Me gustaría recibir más información.';
const waLink = `https://wa.me/${waNumber}?text=${encodeURIComponent(waMessage)}`;

export const FloatinButton = () => {
  return (
    <div className='fixed bottom-6 right-6 z-50 flex flex-col items-end group'>
      
      {/* Tooltip (Mensaje emergente al hacer hover) */}
      <div className='mb-3 px-4 py-2 bg-brand-card border border-border text-text-main text-sm font-medium rounded-lg shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity duration-300'>
        ¡Chatea con nosotros!
      </div>
